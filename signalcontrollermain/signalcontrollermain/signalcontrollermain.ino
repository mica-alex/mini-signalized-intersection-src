...
const int signal_walkTimeMs = 12000;           // Time of Walk/Bike Phase (Milliseconds)
const int signal_flashDontWalkTimeMs = 16000;  // Time of Flash Dont Walk/Bike Phase (Milliseconds)
...
const int slot_thirdGreen = 2;     // PLC Slot Index for Third Signal Green
const int slot_thirdYellow = 2;    // PLC Slot Index for Third Signal Yellow
const int slot_thirdRed = 2;       // PLC Slot Index for Third Signal Red
...
const int point_thirdGreen = 3;    // PLC Slot Point Index for Third Signal Green
const int point_thirdYellow = 2;   // PLC Slot Point Index for Third Signal Yellow
const int point_thirdRed = 1;      // PLC Slot Point Index for Third Signal Red
...
void setup() {
  ...
  unsigned long ethernetWaitTimeMin = millis() + 45000;
...
void setGreenPhase() {
  ...
  setPointPower(LOW, slot_thirdRed, point_thirdRed);
  setPointPower(LOW, slot_thirdYellow, point_thirdYellow);
  setPointPower(HIGH, slot_thirdGreen, point_thirdGreen);
...
void setYellowPhase() {
  ...
  setPointPower(state_isPedEnabled ? HIGH : LOW, slot_dontWalk, point_dontWalk);
  setPointPower(LOW, slot_thirdRed, point_thirdRed);
  setPointPower(HIGH, slot_thirdYellow, point_thirdYellow);
  setPointPower(LOW, slot_thirdGreen, point_thirdGreen);
  setPointPower(HIGH, slot_secondRed, point_secondRed);
  setPointPower(LOW, slot_secondYellow, point_secondYellow);
  setPointPower(LOW, slot_secondGreen, point_secondGreen);
  setPointPower(LOW, slot_firstRed, point_firstRed);
...
void setAllRedPhaseWithBikeWithWalk() {
  ...
  setPointPower(HIGH, slot_thirdRed, point_thirdRed);
  setPointPower(LOW, slot_thirdYellow, point_thirdYellow);
  setPointPower(LOW, slot_thirdGreen, point_thirdGreen);
